...
class Features(FeatureBlock):
    def __init__(self):
        super(Features, self).__init__(
            ...
            OrderedDict(
                [
                    ("HalfKAE", NUM_PLANES * NUM_SQ + (NUM_PLANES - 90) * NUM_SQ * 3),
                    ("HalfKA", NUM_PLANES * NUM_SQ),
                ]
            ),
        )
    ...
    def get_feature_factors(self, idx):
        ...
        return [idx, self.get_factor_base_feature("HalfKA") + ka_index]
...
class FactorizedFeatures(FeatureBlock):
    ...
    def get_feature_factors(self, idx):
        ...
        return [
            idx,
            self.get_factor_base_feature("HalfKA") + ka_index,
